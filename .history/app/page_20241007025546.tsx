    ...
    <main className="mb-40">
      <div className="flex justify-evenly">
        ...
        <div className="flex flex-col">
            ...
            <div>
                <button className="bg-primary p-4 px-12 rounded-xl text-white text-lg mr-10 w-36">Practice</button>
                <button className="bg-primary p-4 px-12 rounded-xl text-white text-lg w-36">Exam</button>
            </div>
        </div>
      </div>
    </main>
