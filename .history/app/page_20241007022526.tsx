    ...
    <main>
      <div>
        <div className="flex flex-col items-center">
          ...
          <div className=" mt-20 mb-10 rounded-full w-80 bg-customOrange">
            <div className="bg-secondary rounded-full flex justify-center py-1 px-2 bg-customOrange">
              <span className="text-xl " style={{ padding: "inherit" }}>
          ...
          <div className=" mt-20 mb-10 rounded-full w-80">
            <div className="bg-secondary rounded flex justify-between py-1.5 px-2 ">
              <span className="text-xl " style={{ padding: "inherit" }}>
                Begginer
              </span>
              <span className="text-xl " style={{ padding: "inherit" }}>
          ...
          <div className=" =mb-10 rounded w-95">
            <div className="bg-secondary rounded flex justify-center py-1 px-2 ">
              <span className="text-xl " style={{ padding: "inherit" }}>
