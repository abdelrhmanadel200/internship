...
const PricingCard = ({ plan, price, attempts }:PricingCardProps )=> (
  <div className={`w-96 h-[450px] rounded-lg border-2 border-[#006565] bg-white flex flex-col items-center justify-evenly transition duration-300 ease-in-out text-[#006565] hover:bg-primary  hover:text-white cursor-pointer md:max-lg:w-90 mb-10 cards-container`}>
