...
const PricingCard = ({ plan, price, attempts }:PricingCardProps )=> (
  <div className={`w-96 h-[450px] rounded-lg border-2 border-[#006565] bg-white flex flex-col items-center justify-evenly transition duration-300 ease-in-out text-[#007676] hover:bg-primary  hover:text-white cursor-pointer`}>
