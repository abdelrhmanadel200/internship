...
const PricingCard = ({ plan, price, attempts }:PricingCardProps )=> (
  <div className={`w-96 h-[450px] rounded-lg border-2 border-[#006565] bg-white flex flex-col items-center justify-evenly transition duration-300 ease-in-out text-[#006565] hover:bg-primary  hover:text-white cursor-pointer md:max-lg:w-90`}>
...
const Pricing = () => {
  return (
      <section className="container mx-auto px-4 py-16">
        <div className={`text-center text-5xl font-light mb-16 text-[#006565] font-medium md:max-lg:text-4xl`}>
