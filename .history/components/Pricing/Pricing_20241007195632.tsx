...
const PricingCard = ({ plan, price, attempts }:PricingCardProps )=> (
  <div className={`w-96 h-[450px] rounded-lg border-2 border-teal-700 bg-white flex flex-col items-center justify-evenly transition duration-300 ease-in-out hover:bg-primary  hover:text-white cursor-pointer`}>
