...
const NavBarHome = () => {
  ...
  return (
    <div className={`py-5 ${inter.className} bg-green`}>
      <nav className="relative flex items-center justify-between h-16 container mx-auto px-4" >
        ...
        <div className="hidden lg:flex items-center mr-4">
          <Link href="/views/auth/signup" className="bg-[#007676] text-white rounded-full w-[156px] h-[50px] flex items-center justify-center text-base font-bold transition-all duration-300 ease-in-out hover:bg-[#005555] hover:shadow-lg color:primary">
            GET STARTED
          </Link>
        </div>
      </nav>
